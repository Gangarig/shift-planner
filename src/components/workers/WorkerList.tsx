...
function WorkerList({workers,selectedWorker,setSelectedWorker,stations,onUpdateWorker}:WorkerListProps) {
    const availableWorkers = workers.filter(worker => ['available', 'late'].includes(worker.status))
