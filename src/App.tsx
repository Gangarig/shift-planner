...
function App() {
  ...
  return <AuthProvider><Suspense fallback={<Container py={80}><Text ta="center" c="dimmed">Loading ShiftPlanner…</Text></Container>}><RouterProvider router={router} /></Suspense></AuthProvider> }
export default App
